...
import com.goodwy.dialer.fragments.MyViewPagerFragment.InnerBinding
...
//    class DIDCommInnerBinding(
//        val lettersBinding: FragmentLettersLayoutBinding,
//        val didCommBinding: FragmentDidcommBinding
//    ) : InnerBinding {
//        override val fragmentList: MyRecyclerView = lettersBinding.fragmentList
//        override val recentsList: MyRecyclerView? = null
//    }

    class DIDCommInnerBinding(val binding: FragmentRecentsBinding) : InnerBinding {
        override val fragmentList = null
        override val recentsList = binding.recentsList
    }
//    class DIDCommInnerBinding(
//        private val binding: FragmentLettersLayoutBinding
//    ) : MyViewPagerFragment.InnerBinding {
//
//        override val fragmentList: MyRecyclerView?
//            get() = binding.fragmentList
//
//        override val recentsList: MyRecyclerView?
//            get() = binding.fragmentList // Or null, or another list, depending on your layout
//    }
}
