...
class Config(context: Context) : BaseConfig(context) {
    companion object {
        ...
        // Preference keys
        private const val DIDCOMM_VIEW_TYPE = "didcomm_view_type"
        private const val DIDCOMM_GRID_COLUMN_COUNT = "didcomm_grid_column_count"
    }
    ...
    var didCommViewType: Int
        get() = prefs.getInt(DIDCOMM_VIEW_TYPE, VIEW_TYPE_LIST)
        set(value) = prefs.edit().putInt(DIDCOMM_VIEW_TYPE, value).apply()

    var didCommGridColumnCount: Int
        get() = prefs.getInt(DIDCOMM_GRID_COLUMN_COUNT, DEFAULT_GRID_COLUMNS)
        set(value) = prefs.edit().putInt(DIDCOMM_GRID_COLUMN_COUNT, value).apply()
}
